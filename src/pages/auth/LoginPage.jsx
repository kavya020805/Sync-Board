...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-[400px] animate-fade-in">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-(--color-text-primary) tracking-tight mb-2">Welcome back</h1>
        <p className="text-sm text-(--color-text-secondary)">Sign in to your account to continue</p>
      </div>
